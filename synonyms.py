# 版权说明: 本文件吸收自 lxr2010/TrailsInTheSkyRemakeScriptAligner (GPL-3.0)
# 原作者: lxr2010  原文件: synonyms.py
# 包含: 轨迹系列术语同义映射(kanji/katakana)、Falcom 外字(gaiji)表、normalize 归一化
# https://github.com/lxr2010/TrailsInTheSkyRemakeScriptAligner
