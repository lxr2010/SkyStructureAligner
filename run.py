...
ASSETS = {
    'fc':  ['evo_structure.json', 'additional_voice_fc.json', 'speaker_map_fc.json', 'script_data_fc.json'],
    'sc':  ['evo_structure_sc.json', 'additional_voice_sc.json', 'speaker_map_sc.json', 'script_data_sc.json'],
    '3rd': ['evo_structure_3rd.json', 'additional_voice_3rd.json', 'script_data_3rd.json'],
}
